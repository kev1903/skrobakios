-- Fix data duplication in get_manageable_users_for_user function
-- This ensures each user appears only once by using DISTINCT ON and aggregating company roles
