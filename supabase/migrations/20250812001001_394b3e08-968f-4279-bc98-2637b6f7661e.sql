-- Delete existing 5.4 FIXING STAGE activities and replace with new ones
-- First, delete all existing 5.4 FIXING STAGE activities
DELETE FROM public.activities 
WHERE project_id = '844f29f2-fff0-43c0-943b-cef8add9e563' 
AND stage = '5.4 FIXING STAGE';

-- Insert new 5.4 FIXING STAGE activities
INSERT INTO public.activities (
  ...
  ('844f29f2-fff0-43c0-943b-cef8add9e563', '4042458b-8e95-4842-90d9-29f43815ecf8', 'Hydronic In-Slab Heating', '', '5.4 FIXING STAGE', 55000.00, 17000.00, 2, 15),
