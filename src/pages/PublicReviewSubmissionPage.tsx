...
export const PublicReviewSubmissionPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!projectId) {
      toast({
        title: "Error",
        description: "Invalid project link",
        variant: "destructive"
      });
      return;
    }
...
- Author: ${validatedData.author}${validatedData.reviewer ? `\n- Requested Reviewer: ${validatedData.reviewer}` : ''}`;
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-accent/10 p-4">
        <div className="w-full max-w-md text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-playfair font-semibold">Submission Successful</h1>
            <p className="text-muted-foreground">
              Your document review request has been submitted successfully. The project team will review your submission.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/10 p-4 sm:p-8">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white/80 backdrop-blur-xl border border-border/30 rounded-2xl shadow-[0_2px_16px_rgba(0,0,0,0.04)] p-6 sm:p-8 space-y-6">
          <div className="space-y-2 border-b border-border/30 pb-6">
            <h1 className="text-2xl font-playfair font-semibold">Submit Document for Review</h1>
            <p className="text-sm text-muted-foreground">
              Submit your document for review. All submissions will be assigned to the project team.
            </p>
          </div>
