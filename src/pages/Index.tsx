      ...
      <TaskProvider>
        {currentPage === "sales" || currentPage === "landing" || currentPage === "auth" ? (
          ...
          <div className="flex h-screen min-h-0">
            <div className={`flex-1 bg-background transition-all duration-300 ${currentPage !== "landing" && currentPage !== "auth" ? (isChatCollapsed ? "pr-0" : "pr-96") : ""}`}>
              <ContentRenderer 
          ...
          <div className="h-screen min-h-0 bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 relative">
            ...
            <div className="relative z-10 flex h-screen min-h-0">
              <div className={`flex-1 bg-background transition-all duration-300 ${isChatCollapsed ? "pr-0" : "pr-96"}`}>
