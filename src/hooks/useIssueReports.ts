...
export const useIssueReports = (projectId?: string) => {
  ...
  const createReport = async (reportData: Partial<IssueReport>) => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to create Issue report",
        variant: "destructive",
      });
      throw err;
    }
  ...
  const deleteReport = async (id: string) => {
    try {
      ...
      console.error('Error deleting Issue report:', err);
      toast({
        title: "Error",
        description: "Failed to delete Issue report",
        variant: "destructive",
      });
    }
  };
