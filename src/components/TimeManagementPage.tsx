...
export const TimeManagementPage = ({ onNavigate }: TimeManagementPageProps) => {
  ...
  return (
    <div className={cn("w-full flex flex-col bg-gradient-to-br from-background via-background to-muted/10", minHeightClasses)}>
      <div className="flex-1 flex flex-col max-w-[1800px] mx-auto w-full">
        {/* Header - Not sticky, part of scrollable content */}
