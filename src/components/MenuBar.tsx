        ...
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center space-x-4">
            {activeTimer && <>
                ...
                {activeTimer.category && <span className="px-2 py-1 text-xs bg-muted text-foreground rounded-md border border-border">
                    {activeTimer.category}
                  </span>}
                
                {activeTimer.project_name && <span className="px-2 py-1 text-xs bg-muted text-foreground rounded-md border border-border">
          ...
          <div className="flex items-center space-x-3">
            ...
            {isAuthenticated ? <>
                ...
                {/* Inbox Icon */}
                <button onClick={() => window.location.href = '/?page=inbox'} className="w-8 h-8 bg-muted/50 backdrop-blur-sm rounded-md border border-border flex items-center justify-center hover:bg-muted transition-colors duration-200 text-foreground">
