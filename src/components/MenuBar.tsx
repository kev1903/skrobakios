...
export const MenuBar = () => {
  ...
  return (
    <>
      <div ref={barRef} className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-background/80 border-b border-border shadow-lg md:pr-[var(--ai-chat-offset,0px)] transition-[padding] duration-300">
