...
export const BusinessMapbox: React.FC<{ className?: string }> = ({ className = '' }) => {
  ...
  if (loading) {
    return (
      <div className={`w-full min-h-screen bg-background flex items-center justify-center ${className}`}>
  ...
  return (
    <div className={`w-full min-h-screen bg-transparent relative ${className}`}>
      {/* Map Container */}
