...
export const PageShell: React.FC<PageShellProps> = ({ children, className = '', withPattern = false }) => {
  return (
    <div className={`relative mt-0 md:mt-[var(--header-height,64px)] min-h-screen md:min-h-[calc(100vh-var(--header-height,64px))] bg-white w-full transition-[padding] duration-300 ${className}`}>
