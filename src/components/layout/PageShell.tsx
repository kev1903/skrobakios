...
export const PageShell: React.FC<PageShellProps> = ({ children, className = '', withPattern = false }) => {
  return (
    <div className={`relative mt-[var(--header-height,64px)] min-h-[calc(100vh-var(--header-height,64px))] overflow-auto bg-white w-full transition-[padding] duration-300 ${className}`}>
