  ...
  return (
    <div className="flex items-center justify-between mb-8">
      ...
      <div className="flex items-center space-x-4">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-[#3366FF] to-[#1F3D7A] bg-clip-text text-transparent">
            Dashboard
          </h1>
          <p className="text-gray-600 text-sm mt-1">Welcome back! Here's what's happening today.</p>
        </div>
        <Badge className="bg-[#3366FF] text-white px-3 py-1 rounded-full text-sm font-medium shadow-lg">
      ...
      <div className="flex items-center space-x-3">
        ...
        {/* 3D View Button */}
        <Button
          className="flex items-center space-x-2 bg-gradient-to-r from-[#3366FF] to-[#1F3D7A] hover:from-[#1F3D7A] hover:to-[#3366FF] text-white shadow-lg hover:shadow-xl transition-all duration-200"
        ...
        <div className="flex items-center space-x-3 bg-white/80 backdrop-blur-sm rounded-full p-2 shadow-lg border border-gray-200">
          <Avatar className="w-8 h-8 ring-2 ring-[#E6F0FF]">
            <AvatarImage src="/lovable-uploads/39fa74b4-f31c-4e52-99aa-01226dcff8a5.png" />
            <AvatarFallback className="bg-[#3366FF] text-white text-sm">
              LP
            </AvatarFallback>
          </Avatar>
          <div className="pr-2">
