  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100">
      <div className="h-screen flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-6 bg-white/70 backdrop-blur-xl border-b border-gray-200/50">
          <button
            onClick={onBack}
        ...
        <div className="flex-1 overflow-hidden">
          <div className="h-full bg-white/70 backdrop-blur-xl border-gray-200/50">
            <Tabs defaultValue="timeblocking" className="h-full flex flex-col">
              ...
              <TabsContent value="general" className="space-y-6 mt-6 mx-6">
                {/* Time Settings */}
              ...
              <TabsContent value="display" className="space-y-6 mt-6 mx-6">
                {/* Display Settings */}
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-4">
              ...
              <TabsContent value="tasks" className="space-y-6 mt-6 mx-6">
                {/* Task Settings */}
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-4">
              ...
              <TabsContent value="timeblocking" className="flex-1 overflow-hidden m-6 mt-4">
                ...
                <div className="h-full flex flex-col space-y-4">
                  ...
                  <div className="flex-1 bg-white/50 backdrop-blur-sm rounded-lg border border-gray-200/50 p-4">
