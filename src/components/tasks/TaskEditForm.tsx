...
export const TaskEditForm = ({
  ...
  return <div className="space-y-6 mt-6">
      ...
      <div className="space-y-2">
        ...
        <Input value={task.taskName} onChange={e => onFieldChange('taskName', e.target.value)} placeholder="Enter task name..." />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Select value={task.priority} onValueChange={value => onFieldChange('priority', value as 'High' | 'Medium' | 'Low')}>
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-2">
        ...
        <Select value={task.status} onValueChange={value => onFieldChange('status', value as Task['status'])}>
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-2">
        ...
        <Input type="range" min="0" max="100" value={task.progress} onChange={e => onFieldChange('progress', parseInt(e.target.value))} className="w-full" />
