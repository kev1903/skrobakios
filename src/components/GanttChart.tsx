      ...
      <div className="overflow-x-auto">
        ...
        <div className="relative">
          {flatTasks.map((task, index) => (
            <div key={task.id} className="flex border-b border-gray-100 hover:bg-gray-50 min-w-fit">
              {/* Task Name Column */}
              ...
              {/* Timeline Column */}
              <div className="relative h-12 bg-white" style={{ width: `${weeks.length * 200}px` }}>
                <div className="absolute inset-0 flex">
                  {weeks.map((_, weekIndex) => (
                    <div key={weekIndex} className="w-[200px] border-r border-gray-200 last:border-r-0 flex-shrink-0">
