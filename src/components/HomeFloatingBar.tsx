...
export const HomeFloatingBar = ({
  ...
  return (
    ...
    {/* Navigation Ribbon */}
    {isRibbonOpen && (
      <div className="fixed left-0 top-20 w-64 h-[calc(100vh-5rem)] bg-white/10 backdrop-blur-md border-r border-white/20 shadow-2xl z-40 transition-all duration-300">
