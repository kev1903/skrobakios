...
export const HomeFloatingBar = () => {
  return (
    <div className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-4xl px-6">
      <div 
        className="flex items-center justify-between px-6 py-4 rounded-2xl shadow-2xl"
        style={{
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 pr-4 py-2 text-sm border-white/20 focus:border-white/40 focus:ring-white/30 bg-white/20 backdrop-blur-sm shadow-sm text-white placeholder-white/60 hover:bg-white/25 transition-all duration-200"
            />
          </div>
        </div>
