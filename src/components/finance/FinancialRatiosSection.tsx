      ...
      <CardContent className="p-6 pt-0">
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center p-4 bg-luxury-gold/10 rounded-xl">
            <div className="text-3xl font-bold font-playfair text-luxury-gold">2.4</div>
          ...
          <div className="text-center p-4 bg-emerald-50 rounded-xl">
            <div className="text-3xl font-bold font-playfair text-emerald-500">1.8</div>
          ...
          <div className="text-center p-4 bg-violet-50 rounded-xl">
            <div className="text-3xl font-bold font-playfair text-violet-500">0.3</div>
          ...
          <div className="text-center p-4 bg-amber-50 rounded-xl">
            <div className="text-3xl font-bold font-playfair text-amber-500">12.5%</div>
