...
export const TaskCostTable = ({
  ...
  return (
    <div className="bg-card border rounded-xl overflow-hidden">
      ...
      {/* Approach 2: Synchronized Split Panels with Exact Row Heights */}
      <div className="flex h-full w-full bg-white overflow-hidden">
        {/* Combined Header Row */}
        <div className="w-full">
          <div className="bg-slate-100/70 border-b border-slate-200 flex sticky top-0 z-10">
            {/* Left Panel Header */}
            ...
            <div className="flex-1 px-2 py-2 text-xs font-medium text-slate-700">
              <div className="grid items-center w-full h-full" style={{
                  ...
                  flatWBSItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* WBS Column */}
                        <div className="px-2 flex items-center text-xs font-mono h-7">
                          <div style={{ 
                        ...
                        {/* Name Column */}
                        <div className="px-3 flex items-center text-xs h-7">
                          <div style={{ 
              ...
              >
                {flatWBSItems.map((item) => {
                  return (
                    <div
                      key={`right-${item.id}`}
                      className={`grid items-center w-full border-b border-slate-100 ${
                        item.level === 0 
                          ? 'bg-gradient-to-r from-slate-100 via-blue-50 to-slate-100 border-l-[6px] border-l-blue-800 shadow-sm hover:from-blue-50 hover:to-blue-100' 
                          : item.level === 1
                          ? 'bg-gradient-to-r from-blue-50 via-blue-100 to-blue-50 border-l-[4px] border-l-blue-400 hover:from-blue-100 hover:to-blue-200'
                    ...
                    >
                      {/* Description */}
                      <div className="px-3 flex items-center text-muted-foreground text-xs h-7">
                        <EditableCell
                          id={item.id}
                          field="description"
                      ...
                      {/* Budget */}
                      <div className="px-2 flex items-center justify-end text-xs text-muted-foreground h-7">
                        <EditableCell
                          id={item.id}
                          field="budgeted_cost"
                      ...
                      {/* Variance */}
                      <div className="px-2 flex items-center justify-end text-xs h-7">
                      ...
                      {/* Cost Code */}
                      <div className="px-2 flex items-center text-xs text-muted-foreground h-7">
                        <EditableCell
                          id={item.id}
                          field="cost_code"
                          value={''}
