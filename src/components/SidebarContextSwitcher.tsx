...
export const SidebarContextSwitcher = ({ onNavigate, isCollapsed = false }: SidebarContextSwitcherProps) => {
  ...
  if (loading) {
    return (
      <Button 
        variant="ghost" 
        className="w-full justify-start text-muted-foreground hover:bg-muted hover:text-foreground border border-white/20 bg-white/5 h-auto p-2" 
        disabled
      >
        Loading...
      </Button>
    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button 
            variant="ghost" 
            className="w-full h-10 p-2 text-muted-foreground hover:bg-muted hover:text-foreground border border-white/20 bg-white/5"
          >
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="ghost" 
          className="w-full justify-between text-muted-foreground hover:bg-muted hover:text-foreground border border-white/20 bg-white/5 h-auto p-3"
        >
