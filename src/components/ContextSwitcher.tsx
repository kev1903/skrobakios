...
export const ContextSwitcher = ({ onNavigate }: ContextSwitcherProps = {}) => {
  ...
  const getActiveContextInfo = (): ActiveContext => {
    if (activeContext === 'personal') {
      return {
        type: 'personal',
        name: `${userProfile.firstName} ${userProfile.lastName}`.trim() || 'Personal',
      ...
      return {
        ...
        description: currentCompany ? 'Company workspace' : 'No company selected'
      };
    }
  };
          ...
          <div className="flex items-center space-x-3 min-w-0 flex-1">
            ...
            <div className="flex flex-col items-start min-w-0 flex-1">
              <div className="flex items-center space-x-2">
                ...
                >
                  {currentContext.type === 'personal' ? 'Personal' : 'Company'}
                </Badge>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col">
                  <span className="font-medium text-sm">
                    {`${userProfile.firstName} ${userProfile.lastName}`.trim() || 'Personal'}
                  </span>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-muted-foreground capitalize">
                        {company.role} • Company workspace
                      </span>
                    </div>
