          ...
          <div className="h-full grid grid-cols-1 md:grid-cols-[1fr_320px] gap-6 p-6">
            ...
            <div className="overflow-auto">
              <div className="rounded-lg border">
                <div className="p-6 text-sm text-muted-foreground">Cost Database content coming soon...</div>
              </div>
            </div>
            ...
            <div>
              <div className="rounded-lg border border-dashed bg-muted/30 p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">Cost database tools will appear here</p>
              </div>
            </div>
          </div>
        </div>
